	...
	<div class="legal-card">
		<section id="scope">
			...
			<p>
				...
				service, and through service providers used to run the app.
			</p>
		</section>
		...
		<section id="account-security">
			<h2>III. Account, Session, and Security Data</h2>
			<p>
				Task Monster uses account and security data to create accounts, authenticate users, manage
				sessions, revoke sessions, detect suspicious access, and maintain service integrity.
			</p>
			<p>
				Passwords are not stored in plain text. Session handling, login attempt logging, and related
				security controls are used to reduce abuse and protect accounts.
			</p>
		</section>

		<section id="task-productivity">
			<h2>IV. Task, Note, and Productivity Data</h2>
			<p>
				Task Monster is built around task-management and run-tracking workflows. Information you add
				to the app may include task names, task notes, per-run notes, queue or daymap placement,
				panic-mode usage, timing data, and historical task status changes.
			</p>
			<p>
		...
		<section id="sharing">
			...
			<p>
				...
				respond to valid legal requests, protect the safety or rights of users or others, or prevent
		...
		<section id="retention">
			...
			<p>
				Retention periods may vary by data type. For example, account and security records may need
				to outlast individual sessions, and backups may temporarily retain data after a live record
		...
		<section id="security">
			...
			<p>
				...
				password storage, session management, access restrictions, and service-level monitoring.
			</p>
			<p>
				No method of storage, messaging, or transmission is completely secure. You should use a
				strong password, protect your devices, and avoid sending sensitive information through the
				service unless you are comfortable with the residual risk.
			</p>
		</section>
		...
		<section id="transfers">
			...
			<p>
				...
				processed where the service operator or its providers maintain systems.
			</p>
		</section>
		...
		<section id="changes">
			...
			<p>
				Continued use of the service after a policy update may be treated as acceptance of the
